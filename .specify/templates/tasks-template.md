...
- [ ] T012 [P] [US1] Property test for [Entity] using proptest (REQUIRED per constitution for domain entities)
...
- [ ] T021 [P] [US2] Property test for [Entity] using proptest (REQUIRED per constitution for domain entities)
...
- [ ] T028 [P] [US3] Property test for [Entity] using proptest (REQUIRED per constitution for domain entities)
